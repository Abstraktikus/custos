...
// and (version >= 2) + int32 identityN, and (version >= 3) + 16 route bytes, and (version >= 4) + 1
// mainLROnly byte. Version 1 blobs parse with identityN = 0. Version 1/2 blobs parse with an identity
// route. Version 1/2/3 blobs parse with mainLROnly = false.
